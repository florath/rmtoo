...
class LatexJinja2(StdOutputParams, ExecutorTopicContinuum, CreateMakeDependencies):
    ...
    def __init__(self, oconfig):
        ...
        templateLoader = jinja2.FileSystemLoader(searchpath="./latex/LatexJinja2/")
    ...
    def requirement_old_unused(self, req):
        ...
        if len(req.incoming) > 0:
            ...
            self.__fd.write(u", ".join(
                ["\\ref{%s} \\nameref{%s}" %
                 (LatexJinja2.__strescape(d.get_id()),
                  LatexJinja2.__strescape(d.get_id()))
        ...
        for rattr in self._config.get_value("req_attributes"):
            if rattr == "Id":
                ...
                raise RMTException(85, "Wrong LatexJinja2 output configuration "
