...
\end{tabular}\end{center} }% REQ 'CleanUpSeats'
...
\textbf{Dependent:} \ref{RoughlyCleanUpSeats} \nameref{RoughlyCleanUpSeats}, \ref{CoverWithBlankets} \nameref{CoverWithBlankets}, 
...
\textbf{Class:} & detailable & & & & \\ 
\end{tabular}\end{center} }% REQ 'CleanUpVicentAndJules'
...
\textbf{Dependent:} \ref{SoapAndColdWater} \nameref{SoapAndColdWater}, \ref{TakeOff} \nameref{TakeOff}, \ref{TakeCareOfClothing} \nameref{TakeCareOfClothing}, 
...
\textbf{Invented on:} & 1994-04-04 & \textbf{Invented by:} & VincentAndJules & \textbf{Status:} & open \\ 
\textbf{Class:} & detailable & & & & \\ 
\end{tabular}\end{center} }% REQ 'CorpseInTrunk'
...
\end{tabular}\end{center} }% REQ 'CoverWithBlankets'
...
\textbf{Invented on:} & 1994-04-04 & \textbf{Invented by:} & Wulf & \textbf{Status:} & open \\ 
\textbf{Class:} & implementable & & & & \\ 
\end{tabular}\end{center} }% REQ 'CreateOrder'
...
\textbf{Dependent:} \ref{DeadManDisapper} \nameref{DeadManDisapper}, \ref{CleanUpVicentAndJules} \nameref{CleanUpVicentAndJules}, \ref{CleanUpCar} \nameref{CleanUpCar}, 
...
\textbf{Invented on:} & 1994-04-04 & \textbf{Invented by:} & VincentAndJules & \textbf{Status:} & open \\ 
\textbf{Class:} & detailable & & & & \\ 
\end{tabular}\end{center} }% REQ 'DeadManDisapper'
...
\textbf{Invented on:} & 1994-04-04 & \textbf{Invented by:} & VincentAndJules & \textbf{Status:} & open \\ 
\textbf{Class:} & detailable & & & & \\ 
\end{tabular}\end{center} }% REQ 'DetergentForCar'
...
\textbf{Invented on:} & 1994-04-04 & \textbf{Invented by:} & Wulf & \textbf{Status:} & open \\ 
\textbf{Class:} & implementable & & & & \\ 
\end{tabular}\end{center} }% REQ 'RoughlyCleanUpSeats'
...
\textbf{Invented on:} & 1994-04-04 & \textbf{Invented by:} & Wulf & \textbf{Status:} & open \\ 
\textbf{Class:} & implementable & & & & \\ 
\end{tabular}\end{center} }% REQ 'SoapAndColdWater'
...
\textbf{Invented on:} & 1994-04-04 & \textbf{Invented by:} & Wulf & \textbf{Status:} & open \\ 
\textbf{Class:} & implementable & & & & \\ 
\end{tabular}\end{center} }% REQ 'TakeCareOfClothing'
...
\textbf{Invented on:} & 1994-04-04 & \textbf{Invented by:} & Wulf & \textbf{Status:} & open \\ 
\textbf{Class:} & implementable & & & & \\ 
\end{tabular}\end{center} }% REQ 'TakeOff'
