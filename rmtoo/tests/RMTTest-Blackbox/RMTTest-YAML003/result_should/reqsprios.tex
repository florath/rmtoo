...
\begin{longtable}{|r|c|p{7cm}||r|r|} \hline
\textbf{Prio} & \textbf{Chap} & \textbf{Requirement Id} & \textbf{EfE} & \textbf{Sum} \\ \hline\endhead
10.00 & \ref{SimpleReq} & \nameref{SimpleReq} & 3 & 3 \\ \hline
10.00 & \ref{SetupProject} & \nameref{SetupProject} & 3 & 6 \\ \hline
9.00 & \ref{TestExecution} & \nameref{TestExecution} & 1 & 7 \\ \hline
8.00 & \ref{CreateFiles} & \nameref{CreateFiles} & 2 & 9 \\ \hline
